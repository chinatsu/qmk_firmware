...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_LCTL,KC_LGUI,KC_LALT,   KC_SPC,   KC_SPC,    KC_SPC,  KC_SPC, KC_RALT,KC_RCTL,MO(1),      KC_LEFT,KC_DOWN,KC_RGHT
    ),
    [_FN] = LAYOUT(
        ...
        _______,_______,_______,   _______,   _______, _______, _______,_______,_______,MO(1),       _______,_______,_______
    )
};
