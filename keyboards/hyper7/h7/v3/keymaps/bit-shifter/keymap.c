...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_h7v3_183(
        KC_H,              KC_M,              KC_T,                 KC_Q,                KC_O,                    KC_C,                    KC_C,                           KC_H,                      KC_S,                   KC_A,              KC_B,                 KC_R,                KC_C,                KC_R,           //14
        KC_L,              KC_N,              KC_S,                 KC_R,                KC_B,                    KC_1,                    KC_2,                           KC_3,                      KC_4,                   KC_R,              KC_T,                 KC_S,                KC_S,                KC_CLCK,           //14
        KC_F1,   KC_F2,    KC_C,  KC_O,       KC_ESC,               KC_QUES,    KC_EXLM, X(AT_SYMBOL),    X(GBP), X(EURO),        X(JPY),  X(BACKTICK),    X(DQUOTE_OPEN), X(DQUOTE_CLOSE), X(PRIME), KC_UNDS,       KC_LABK, KC_RABK,  X(PIPE), KC_LCBR,    KC_RCBR,  KC_C,          KC_CIRC,   KC_PERC,  KC_HASH,  KC_DLR,  //26

        KC_F3,   KC_F4,    KC_FIND,  H_WRITE, KC_LEAD,  H_DOUBLE_QUOTE__PLUS_MINUS, H_COLON__TILDE,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,    KC_6,     KC_7,    KC_8,     KC_9,    KC_0,     KC_MINS,  KC_EQL,  KC_NUBS, H_L_BRACE__L_CHEVRON,  H_R_BRACE__R_CHEVRON,  C(KC_Z),    KC_TILD,   KC_BSLS,  KC_PAST,  KC_PMNS, //27
        ...
        KC_F7,   KC_F8,    KC_SELECT,H_DEBUG, MO(_FN), KC_NO,       KC_NO, KC_A,     KC_S,     KC_D,     KC_F,     KC_G,    KC_H,     KC_J,    KC_K,     KC_L,    H_SEMI_COLON__BACK_TICK,  KC_QUOT,  KC_ENT , H_LINE, H_PAGE,                                                        KC_P4,     KC_P5,    KC_P6,    KC_AMPR, //25
        KC_F9,   KC_F10,   H_TTY,    KC_LOCK, KC_HOME,  KC_END ,  KC_RALT, KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,    KC_B,     KC_N,    KC_M,     KC_COMM, KC_DOT,   KC_SLSH,  KC_RSFT, KC_RALT,KC_UP,    KC_END,                                                              KC_P1,     KC_P2,    KC_P3,    KC_EQL,  //26
        KC_F11,  KC_F12,   KC_HOME,  H_EOF,   G(KC_COMM),  G(KC_DOT),  H_7BIT,  KC_LALT,  KC_HYPR,  KC_LGUI,  KC_LCTL,  KC_SPC,  H_CIRCLE_SM,  KC_DEL,  KC_RCTL,  KC_RGUI, KC_HYPR,  KC_RALT,  KC_LEFT, KC_DOWN, KC_RGHT,                                                             KC_DEL,    KC_P0,    KC_PDOT,  KC_ENTER //25
    ),
    ...
    [_FN] = LAYOUT_h7v3_183(
        ...
        FT,      FT,      FT,       KC_B,   FT,       FT,       FT,       FT,       FT,       FT,       UC_M_WC,  FT,       FT,       FT,       UC_M_MA,  FT,       FT,       FT,       FT,      FT,      FT,       FT,                            FT,      FT,       FT,      FT,
  ...
  if (record->event.pressed) {
    switch(keycode) {
      ...
      if (get_mods() & MODS_SHIFT_MASK) {
          CLEAN_MODS(
            send_string(SS_LCTL(SS_LGUI(SS_TAP(X_BSPACE))));
          );
        } else {
