...
#define L_ENTER LT(1, KC_ENTER)
#define L_A LT(2, KC_A)
#define L_S LT(3, KC_S)
#define L_L LT(2, KC_L)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* Base */
    [_BASE] = LAYOUT(
        KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,   L_ENTER,
         L_A,     L_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    L_L,     KC_UP,
           KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,           KC_LEFT, KC_DOWN, KC_RIGHT
    ),
    [_ENTER] = LAYOUT(
        KC_ESC, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
         KC_TAB, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
           _______, KC_LALT, KC_SPC,  KC_SPC,  KC_SPC,  _______, _______,       _______, _______, _______
    ),
    [_A] = LAYOUT(
    ...
    [_S] = LAYOUT(
         KC_EXCLAIM,KC_AT,KC_HASH,KC_DOLLAR,KC_PERCENT,KC_CIRCUMFLEX,KC_AMPERSAND,KC_ASTERISK,KC_LEFT_PAREN,KC_RIGHT_PAREN,_______,
